...
function ParticipantRegistration() {
  ...
  const handleRegister = async () => {
    try {
      ...
      const registrationsRef = ref(rtdb, `quizzes/${selectedQuiz.id}/registrations`);
      ...
      setSuccess('Registration successful! Check your email for confirmation and quiz link.');
      setName('');
      setEmail('');
      setMobile('');
      setOpenDialog(false);
    ...
    try {
      switch (paymentMethod) {
        ...
        case 'bank':
          ...
          setSuccess('Registration pending. Please complete the bank transfer. Check your email for details and quiz link.');
          setOpenDialog(false);
          break;
      }
    } catch (error) {
