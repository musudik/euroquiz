      ...
      <Router>
        <AppBar position="static" sx={{ backgroundColor: '#000102' }}>
          <Toolbar>
            ...
            <Box sx={{ display: 'flex', gap: 2 }}>
              ...
              <Typography component={Link} to="/manage-quiz" sx={{ color: 'white', textDecoration: 'none' }}>
                Manage Quiz
              </Typography>
              <Typography component={Link} to="/analytics" sx={{ color: 'white', textDecoration: 'none' }}>
                Analytics
              </Typography>
              <Typography component={Link} to="/join" sx={{ color: 'white', textDecoration: 'none' }}>
                Join Quiz
              </Typography>
            </Box>
          </Toolbar>
        ...
        <Container sx={{ mt: 4 }}>
          <Routes>
            ...
            <Route path="/quiz/:quizId/questions" element={<CreateQuizQuestions />} />
            <Route path="/conduct/:quizId" element={<ConductQuiz />} />
            <Route path="/join/:quizId" element={<JoinQuiz />} />
            <Route path="/quiz/:quizId/registrations" element={<QuizRegistrations />} />
          </Routes>
        </Container>
      </Router>
  );
